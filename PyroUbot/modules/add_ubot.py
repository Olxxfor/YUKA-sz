...
async def _(client, callback_query):
    ...
    try:
        phone = await bot.ask(
            user_id,
            (
                "<blockquote><b>ᴋɪʀɪᴍᴋᴀɴ ɴᴏᴍᴏʀ sᴇsᴜᴀɪ ᴋᴏᴅᴇ ɴᴇɢᴀʀᴀ ᴀɴᴅᴀ ᴍɪsᴀʟ 628xxx ᴅᴀɴ sᴀʏᴀ ᴀᴋᴀɴ ᴍᴇᴍᴘʀᴏsᴇs ʟᴏɢɪɴ ᴀɴᴅᴀ \n ɢᴜɴᴀᴋᴀɴ /cancel ᴜɴᴛᴜᴋ ᴍᴇᴍʙᴀᴛᴀʟᴋᴀɴ </b></blockquote>"
            ),
            timeout=300,
        )
...
ɪᴅ : {new_client.me.id}
ᴘʀᴇꜰɪxᴇꜱ : {' '.join(SH)}
ʜᴀʀᴀᴘ ᴊᴏɪɴ : @Junofficial354ch2 ʜᴀʀᴀᴘ ᴊᴏɪɴ ʀᴏᴏᴍ ᴅɪᴀᴛᴀs ᴅᴀɴ ᴊᴀɴɢᴀɴ ᴏᴜᴛ ᴀɢᴀʀ sᴀғᴇᴛʏ
ᴊɪᴋᴀ ʙᴏᴛ ᴛɪᴅᴀᴋ ʀᴇꜱᴘᴏɴ, ᴋᴇᴛɪᴋ /restart</b></blockquote>
    ...
    try:
        await new_client.join_chat("junofficial354ch2")
        await new_client.join_chat("junofficial354gc2")
